...
def create_settings_file(
    app_or_apps: list[App], settings: Settings | dict[str, Any] | None = None, interactive=True
) -> list[Settings]:
    ...
...
@overload
def create_settings_file(
    app_or_apps: App | None = None, settings: Settings | dict[str, Any] | None = None, interactive=True
) -> Settings:
    ...


def create_settings_file(
    app_or_apps: list[App] | App | None = None, settings: Settings | dict[str, Any] | None = None, interactive=True
):
    """
    ...
    if not USE_SQLITE:
        ...
        add_setting(
            "DB_NAME",
            ask("Database name" + (" (without " + USERNAME + "$ prefix)" if PYTHONANYWHERE else ""), "DB_NAME"),
        )
...
def contribute_to_argparse(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--yes", "-y", "--no-interactive", action="store_false", dest="interactive", help="Don't ask questions"
    )
