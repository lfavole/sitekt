...
@overload
def import_path(
    path: Path | str, module: str, package: str | None = None, *, remove_sys_path: Literal[True] = True
) -> ModuleType:
    ...
...
@overload
def import_path(
    path: Path | str, module: str, package: str | None = None, *, remove_sys_path: Literal[False] = False
...
def cprint(
    text: str, color: str | None = None, on_color: str | None = None, attrs: list[str] | None = None, *args, **kwargs
